...
## FULL CONE TO SERVER
iptables -t nat -A PREROUTING -p udp --source 172.16.16.16 --dport $1 -j DNAT --to-destination 10.1.0.2:$1
iptables -t nat -A PREROUTING -p udp --source 172.18.18.18 --dport $2 -j DNAT --to-destination 10.1.0.2:$2
